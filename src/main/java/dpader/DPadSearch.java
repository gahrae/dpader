...
public class DPadSearch {
	...
	public static Algorithm<DPadAction, DPad, WeightedNode<DPadAction, DPad, Double>>.SearchResult search(String message) {
	...
	public static Algorithm<DPadAction, DPad, WeightedNode<DPadAction, DPad, Double>>.SearchResult search(
		...
		if (!allCharactersReachable(initialState, message)) {
			throw new IllegalArgumentException("Message contains characters that are not reachable in dpad.");
		}

		SearchProblem<DPadAction, DPad, WeightedNode<DPadAction, DPad, Double>> problem =
                ProblemBuilder.create()
                    ...
                    .defineProblemWithExplicitActions()
                        ...
                        .useHeuristicFunction(getHeuristicFunction(message))
                        .build();
...
//					System.out.println("Couldn't find " + c);
	...
	public static HeuristicFunction<DPad, Double> getHeuristicFunction(String goal) {
...
//	            			);
	...
	public static Predicate<WeightedNode<DPadAction, DPad, Double>> getPredicateFunction(String goal) {
